package com.lcj.socket.nio.third;
...
public class SetNameFrame extends JFrame {  
    ...
    //参考 http://blog.csdn.net/column/details/ck-nio.html
    /**
     * 目前问题：很多客户端同时连接服务器时会抛出ConcurrentModificationException。其原因是在遍历已注册键时，有客户端连接修改了Selector的已注册键集合
     */
